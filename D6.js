...
const string1 = "uno due",
  string2 = "tre quattro";

const twoConcat = (str1, str2) => str1.slice(0, 2) + str2.slice(-3);

const newString = twoConcat(string1, string2);
...
const tenRandom = () => {
  const numRandom = [];
  for (let i = 0; i < 10; i++) {
    numRandom.push(Math.floor(Math.random() * 101));
  }
  return numRandom;
};
...
const numberArray = [23, 8, 45, 12, 33, 68, 94];

const getEven = (numArray) => numArray.filter((num) => num % 2 === 0);

// console.log(getEven(numberArray));
...
/* ESERCIZIO 5 (reduce)
  Scrivi una funzione per sommare i numeri contenuti in un array
*/
const sumArrayReduce = (numArray) => numberArray.reduce((acc, cur) => acc + cur);

// console.log(sumArrayReduce(numberArray));

/* ESERCIZIO 6 (map)
  Scrivi una funzione che, dato un array di soli numeri e un numero n come parametri, ritorni un secondo array con tutti i valori del precedente incrementati di n
*/

const sumN = (numArray, n) => numArray.map((num) => num + n);

// console.log(sumN(numberArray, 2));
...
const stringArray = ["forza", "il", "Pescara", "biancazzurro"];

const countChar = (ntrArray) => stringArray.map((str) => str.length);

// console.log(countChar(stringArray));
